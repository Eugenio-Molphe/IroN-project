...
parallel -j8 bash /mnt/mnemo5/eugenio/IroN_project/Scripts/IroN-project/2_BlastN/blast_iroN.sh {} \
$db \
/mnt/mnemo5/eugenio/IroN_project/Files/03_IroN_BLAST_results/{/.}.blast.tsv ::: $in/*

# Let's extract the sequences
parallel -j1 python /mnt/mnemo5/eugenio/IroN_project/Scripts/IroN-project/2_BlastN/extract_sequence.py \
